    ...
    <div class="card" style="box-shadow: 10px 10px grey;">
        ...
        <div class="card-body">
            <div class="row text-right">
                ...
                <div class="col-md-6">
                    <form style="padding-bottom: 10px" action="/search-joined" method="POST" role="search">
                        {{ csrf_field() }}
    ...
    @else
        <div class="row">
            <div class="col text-danger text-center">
                <h1 style="margin-top: 10%" class="text-danger">You Have Not Joined Any Events Yet :(</h1>
                @if(DB::table('roles')->where('id', '=', Auth::User()->role_id)->first()->roleName == "Volunteer")
                    <a href="{{url('/home')}}"><button style="width: 200px" class="btn-primary">Join Event Now!</button></a>
                @endif
            </div>
        </div>
    @endif
