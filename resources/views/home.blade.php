...
<div class="container">
    ...
    <div class="card" style="box-shadow: 10px 10px grey;">
        <div class="card-header text-center">
            <div class="col-md-12">
                <h1 class="title tableHeaderTitle">On Going Events</h1>
            </div>
        </div>
        <div class="card-body">
    ...
    @else
        <div class="row">
            <div class="col text-danger text-center">
                <h1 style="margin-top: 10%" class="text-danger">There is Currently No Ongoing Events :(</h1>
            </div>
        </div>
    @endif
    @if(count($pastEvents) > 0 || isset($notFound))
    <div class="card" style="box-shadow: 10px 10px grey; margin-top: 5%">
        <div class="card-header text-center">
            <div class="col-md-12">
                <h1 class="title tableHeaderTitle">Past Events</h1>
            </div>
        </div>
        <div class="card-body">
            <div class="row text-right">
                <div class="col-md-6">
                    <div>{{$pastEvents->links()}}</div>
                </div>
                <div class="col-md-6">
                </div>
            </div>
    ...
    @else
        <div class="row">
            <div class="col text-danger text-center">
                <h1 style="margin-top: 10%" class="text-danger">There is Currently No Past Events :(</h1>
            </div>
        </div>
    @endif
</div>
